...
//@reuired Given an array of" three words" frequentlty "occuring word first" in "ascending order with lower case" 
function getWords(arr) {
const input=arr.toLowerCase().match(/\b[\w']+\b/g);
const frequencyMap={};
...
let arr="Coding in Python is fun because coding Python allows for coding in Python easily while coding";
